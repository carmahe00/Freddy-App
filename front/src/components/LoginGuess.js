...
import { Grid, Avatar, TextField, Button, CircularProgress } from '@material-ui/core'
        ...
        >
            ...
            <Grid item align="center">
                <Formik
                    ...
                    onSubmit={({email, password}) => dispatch(login(email, password, "THIRDS"))}
                >
                    {
                        props => (
